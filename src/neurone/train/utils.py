...
# def targets_mapping(similarity,
#                     sim_thresh,
#                     targets_gt,
#                     targets_pred,
#                     scores,
...
#             if (sim_matrix[gt_i, pred_j] > sim_thresh and not gt_is_tp[gt_i]
...
#             np.concatenate([images_ids_get, images_ids_pred])).astype(int)
...
#         confidences_image = confidences[targets_batched_pred.image_labels() ==
#                                         image_i]
...
#             break_points.pop(-2)
#         if (len(break_points) > 1 and precisions[break_points[-1]]
#                 == precisions[break_points[-2]]):
#             break_points.pop(-1)
...
# def avg_precisions_from_composed(confidences, pred_is_tp, gt_classes,
#                                  pred_classes, class_labels):
#     """
...
#             }
#         else:
#             precisions, recalls = pr_curve(pred_is_tp[ids], confidences[ids],
#                                            total_positives_gt)
